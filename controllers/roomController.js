...
const getRoomsByHotel = asyncHandler(async (req, res) => {
  const rooms = await roomService.getRoomsByHotelService(
    req.params.hotelId
  );
...
const getRoomById = asyncHandler(async (req, res) => {
  const room = await roomService.getRoomByIdService(
    req.params.id
  );
...
const searchRooms = asyncHandler(async (req, res) => {
  const rooms = await roomService.searchRoomsService(
    req.query
  );
...
const updateRoomStatus = asyncHandler(async (req, res) => {
  ...
  getIO().emit("roomStatusUpdated", updatedRoom);
